...
public abstract class OperatorDefinition {
	...
	/**
	 * the extended ID; if the ID is not EXTENED_ID, the string INTRINSIC_EXTENDED_ID.ID is used.
	 * If the ID is EXTENDED_ID, extendedID is an unique string identifying the operator.
	 */
