 ...
 *
 */
public class BinaryLogicalOperatorDefinition extends LogicalOperatorDefinition {

	public BinaryLogicalOperatorDefinition(String name, String extendedID,
										   int position, String symbol, IDomain domain) {
		super(name, extendedID, position, symbol, domain);
		// TODO Auto-generated constructor stub
	}

	public BinaryLogicalOperatorDefinition(String name, int id, int position) {
		super(name, id, position);
		// TODO Auto-generated constructor stub
	}

	public BinaryLogicalOperatorDefinition(String name, int id, String symbol) {
