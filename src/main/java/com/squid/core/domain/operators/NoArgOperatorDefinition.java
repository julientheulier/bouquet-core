...
public abstract class NoArgOperatorDefinition extends OperatorDefinition {
     ...
     * @param domain
     */
    public NoArgOperatorDefinition(String name, int id, IDomain domain) {
     ...
     * @param domain
     */
    public NoArgOperatorDefinition(String name, int id, int position, IDomain domain) {
     ...
     * @param domain
     */
    public NoArgOperatorDefinition(String name, int id, String symbol, IDomain domain) {
     ...
     * @param domain
     */
    public NoArgOperatorDefinition(String name, int id, int position, String symbol, IDomain domain) {
