 ...
 */
public class TranslateTranslateOperatorDefinition extends TranslateOperatorDefinition {

    public static final String ID = StringFunctionsRegistry.STRING_BASE + "TRANSLATE";
