 ...
 */
public class OneArgStringUpperOperatorDefinition extends OneArgStringOperatorDefinition {
    public static final String ID = StringFunctionsRegistry.STRING_BASE + "UPPER";
