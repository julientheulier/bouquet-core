 ...
 */
public class OneArgStringReverseOperatorDefinition extends OneArgStringOperatorDefinition {
    public static final String ID = StringFunctionsRegistry.STRING_BASE + "REVERSE";
