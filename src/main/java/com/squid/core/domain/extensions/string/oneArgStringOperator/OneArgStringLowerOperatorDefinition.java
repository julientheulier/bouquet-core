 ...
 */
public class OneArgStringLowerOperatorDefinition extends OneArgStringOperatorDefinition {

    public static final String ID = StringFunctionsRegistry.STRING_BASE + "LOWER";
