 ...
 */
public class DateCurrentDateOperatorDefinition extends DateOperatorDefinition {
    public static final String ID = DateOperatorDefinition.DATE_BASE+"CURRENT_DATE";

    public DateCurrentDateOperatorDefinition(String name, IDomain domain) {
        super(name, ID, domain);
    }

    public DateCurrentDateOperatorDefinition(String name, IDomain domain, int categoryType) {
        super(name, ID, domain, categoryType);
    }

    public DateCurrentDateOperatorDefinition(String name, String ID, IDomain domain) {
        super(name,ID, domain);
    }

    public DateCurrentDateOperatorDefinition(String name, String ID, IDomain domain, int categoryType) {
        super(name,ID, domain, categoryType);
    }
