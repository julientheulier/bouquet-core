...
implements OperatorRegistry
{
	...
	public void apply(OperatorScope scope) throws OperatorScopeException {
		scope.registerExtension(new SortOperatorDefinition("ASC",SortOperatorDefinition.ASC_ID,DomainSort.ASC, OperatorDefinition.MISC_TYPE));
		scope.registerExtension(new SortOperatorDefinition("DESC",SortOperatorDefinition.DESC_ID,DomainSort.DESC, OperatorDefinition.MISC_TYPE));
	}
