...
public class ScopeException extends ParseException {
     ...
     * 
     */
    private static final long serialVersionUID = 3257571698059522100L;
	...
	public ScopeException(Token currentTokenVal, int[][] expectedTokenSequencesVal, String[] tokenImageVal) {
