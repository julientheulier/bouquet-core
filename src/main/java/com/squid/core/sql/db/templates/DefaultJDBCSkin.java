...
public class DefaultJDBCSkin extends DefaultSQLSkin {
  ...
  /**
   * This flag is true when the Skin have successfully initiated and connected to the database.
   */
  ...
  protected String render(SQLSkin skin, FromTablePiece piece) throws RenderingException, IOException {
    ...
    //
    // joining
    /* if (piece.getJoinDecorator()!=null) { for (Iterator<IJoinDecorator> iter = piece.getJoinDecorator().iterator();iter.hasNext();) { render += " \n     "+iter.next().render(this); } } */
