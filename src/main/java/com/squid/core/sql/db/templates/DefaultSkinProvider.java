...
public class DefaultSkinProvider implements ISkinProvider {
  ...
  public DefaultSkinProvider() {
    ...
    registerOperatorRender(TranslateOperatorDefinition.STRING_TRANSLATE, new ThreeArgsFunctionRenderer("TRANSLATE"));
    ...
    registerOperatorRender(OneArgStringOperatorDefinition.STRING_REVERSE, new StringOneArgOperatorRenderer("REVERSE"));
    registerOperatorRender(OneArgStringOperatorDefinition.STRING_MD5, new StringOneArgOperatorRenderer("MD5"));
    registerOperatorRender(SplitPartOperatorDefinition.STRING_SPLIT_PART, new ThreeArgsFunctionRenderer("SPLIT_PART"));
