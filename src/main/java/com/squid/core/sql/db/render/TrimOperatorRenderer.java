...
public class TrimOperatorRenderer
extends BaseOperatorRenderer
{

	protected final String prepend;

	public TrimOperatorRenderer(String mode) {
		this.prepend = mode;
	}
	...
	public String prettyPrint(SQLSkin skin, OperatorPiece piece, OperatorDefinition opDef, String[] args) throws RenderingException {
		...
		if (args != null) {
			if (args.length!=1 && args.length!=2) {
				throw new RenderingException("invalid syntax for trim operator");
			}
		...
		String str = "TRIM(" + prepend + " " + trimCharacter + " FROM "+ principalstring+")";
		return str;
