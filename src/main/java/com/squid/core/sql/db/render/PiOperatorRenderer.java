 ...
 * Round function
 */
public class  PiOperatorRenderer 
extends BaseOperatorRenderer
{
	public  PiOperatorRenderer() {
	}
	...
	public String prettyPrint(SQLSkin skin, OperatorDefinition opDef, String[] args) throws RenderingException {
		...
		if (args.length!=0) throw new RenderingException("Have not supported function Pi with " + args.length + parameter);
		return "PI()";		
	}
}
