...
public class UpperLowerOperatorRenderer
extends BaseOperatorRenderer
{
	
	private final String prepend;
	
	public UpperLowerOperatorRenderer(String mode) {
		this.prepend = mode;
	}
	...
	public String prettyPrint(SQLSkin skin, OperatorDefinition opDef, String[] args) throws RenderingException {
		...
		if (args != null) {
			if (args.length!=1) throw new RenderingException("invalid syntax for "+prepend+" operator");
