...
extends Statement {
	...
	public InsertSelectStatement(Aliaser aliaser) {
	...
	public void setValue(IPiece[] values) {
		this.value = new ExpressionListPiece(values);
		((ExpressionListPiece) value).setNeedBrackets(false);
	}
	...
	public String getTemplateId() {
		return "insertSelectStatement";//"com.squid.core.sql2.statements.InsertSelectStatement";
	}
