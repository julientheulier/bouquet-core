...
extends Statement 
{
    ...
    private boolean m_forcePKCreation = true;

    /**
     * 
     */
    public DDLCreateTableStatement() {
        super();
    }

    public DDLCreateTableStatement(Table tableDefinition) {
    	m_tableDefinition = tableDefinition;
    }

    public DDLCreateTableStatement(Table tableDefinition, boolean forcePKCreation) {
    	m_tableDefinition = tableDefinition;
    	m_forcePKCreation = forcePKCreation;
    }
