...
extends Statement 
{
     ...
     * 
     */
    public DDLAddPrimaryKey() {
        super();
    }

    public DDLAddPrimaryKey(Table tableDefinition) {
	...
	public String getTemplateId() {
		return "com.squid.core.sql2.statements.DDLAddPrimaryKey";
	}
