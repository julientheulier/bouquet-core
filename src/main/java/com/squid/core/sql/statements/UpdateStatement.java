...
extends Statement {
	...
	private IFromPiece tableToUpdate;
	private ArrayList<ISetterPiece> setters = new ArrayList<ISetterPiece>();
	...
	public IFromPiece getTableToUpdate() {
		return tableToUpdate;
	}

	public void setTableToUpdate(IFromPiece tableToUpdate) {
	 ...
	 * @return the setters
	 */
	public ArrayList<ISetterPiece> getSetters() {
		return setters;
	}
	...
	public String getTemplateId() {
		return "com.squid.core.sql2.statements.UpdateStatement";
	}
